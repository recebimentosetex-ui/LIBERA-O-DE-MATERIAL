...
export const LoadingSpinner: React.FC<{ text?: string }> = ({ text = "Carregando..." }) => (
    <div className="flex justify-center items-center h-full flex-col text-gray-500 dark:text-gray-400">
...
export const ProcessingOverlay: React.FC<{ text?: string }> = ({ text = "Processando..." }) => (
